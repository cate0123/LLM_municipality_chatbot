...
This repository contains the source code, documentation, and resources for an AI-driven chatbot designed to enhance public service delivery for rural municipalities in South Africa. The project implements a Large Language Model (LLM) chatbot that can interact with citizens through municipal websites, providing information, answering queries, and assisting with service requests.


The project is part of a research initiative titled:
**“A Framework for AI-Driven Public Service Delivery: Integrating LLM Chatbots into Rural Municipality Websites in South Africa.”**
